    ...
    onAdd: function onAdd(map) {
        ...
        function loadStory(url) {
            ...
            fetch(url).then(function (response) {
                ...
                story.innerHTML = (0, _marked2.default)(content);
